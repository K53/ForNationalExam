...
var NumofTotalQuestion = 0;
var BeforeQuestionNum = 0;
var NowQuestionNum = 0;
var accessBrance = "/1/" + NowQuestionNum;
var alternativesNum = 0;
var showScore = 0;

document.addEventListener('DOMContentLoaded', function (e) {
    database.ref("/1/0").on("value",function(v){
            NumofTotalQuestion = Number(v.val().length);
