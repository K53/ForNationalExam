...
var NumofTotalQuestion = 240;
var BeforeQuestionNum = 0;
var NowQuestionNum = 0;
var accessBrance = "/5/" + NowQuestionNum;
var alternativesNum = 0;
var showScore = 0;

function InitMem()
{
  database.ref("/t/0").once("value",function(v){
  NumofTotalQuestion = Number(v.val().leng);
  });
  console.log(NumofTotalQuestion);
}
InitMem();
